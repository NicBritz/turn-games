...
# Temp log to console for emails
...
# src: https://medium.com/@whizzoe/
# in-5-mins-set-up-google-login-to-sign-up-users-on-django-e71d5c38f5d5
...
if "AWS" in os.environ:
   ...
   # Bucket Configuration
    ...
    AWS_STORAGE_BUCKET_NAME = "turn-games-static"
